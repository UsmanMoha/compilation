...
static const char *const yytname[] =
{
  ...
  "MINUS", "MULT", "DIV", "LPAREN", "RPAREN", "$accept", "expr", "term",
  "factor", YY_NULLPTR
};
...
#line 29 "myfile.y"
                     { (yyval.value) = (yyvsp[-2].value) + (yyvsp[0].value); result = (yyval.value); }
#line 1146 "y.tab.c"
    break;
