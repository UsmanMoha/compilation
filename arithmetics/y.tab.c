...
static const char *const yytname[] =
{
  ...
  "PLUS", "MINUS", "MULT", "DIV", "LPAREN", "RPAREN", "ASSIGN",
  "SEMICOLON", "$accept", "program", "statement", "expr", "term", "factor", YY_NULLPTR
};
...
{
      14,    -6,    -2,    16,     1,    -6,     2,    -5,    -6,    16,
      -6,    21,    -6,    -6,    16,    16,    -6,    16,    16,    10,
      -6,    -6,    -6,    -6,    -6,    -6
};
...
{
       0,    12,    13,     0,     0,     2,     0,     6,     9,     0,
      13,     0,     1,     3,     0,     0,     4,     0,     0,     0,
      14,     7,     8,    10,    11,     5
};
...
{
      11,    12,    17,    18,     1,     2,    19,    14,    15,     9,
       3,    21,    22,    13,    16,    14,    15,     1,     2,     1,
      10,     0,    25,     3,     0,     3,    14,    15,    23,    24,
       0,    20
};

static const yytype_int8 yycheck[] =
{
       3,     0,     7,     8,     3,     4,     9,     5,     6,    11,
       9,    14,    15,     4,    12,     5,     6,     3,     4,     3,
       4,    -1,    12,     9,    -1,     9,     5,     6,    17,    18,
      -1,    10
};
...
{
       0,     3,     4,     9,    14,    15,    16,    17,    18,    11,
       4,    16,     0,    15,     5,     6,    12,     7,     8,    16,
      10,    16,    16,    17,    17,    12
};
...
#line 40 "file.y"
                                       { update_variable((yyvsp[-3].str), (yyvsp[-1].value)); printf("%s = %lf\n", (yyvsp[-3].str), (yyvsp[-1].value)); }
#line 1170 "y.tab.c"
    break;
...
#line 1182 "y.tab.c"
  ...
  case 10: /* term: term MULT term  */
#line 51 "file.y"
                     { (yyval.value) = (yyvsp[-2].value) * (yyvsp[0].value); }
#line 1188 "y.tab.c"
    break;

  case 11: /* term: term DIV term  */
#line 52 "file.y"
                    { (yyval.value) = (yyvsp[-2].value) / (yyvsp[0].value); }
#line 1194 "y.tab.c"
    break;
...
#line 57 "file.y"
                 { (yyval.value) = get_variable_value((yyvsp[0].str)); }
#line 1200 "y.tab.c"
    break;
